              ...
              <div className="x_title">
                  ...
                  <div className="x_content">
                      <div className="actions portlet-toggler">
                              ...
                              <div className="col-md-3">
                                  <div className="form-group">
                                      <input type="" name="category_name" id="category_name" className="form-control" placeholder="Skill Name"/>
                                  </div>
                              </div>
...
export default ManageAbuseKeywords;